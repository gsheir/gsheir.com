...
class League(models.Model):
    ...
    max_participants = models.IntegerField(default=10, validators=[MinValueValidator(2), MaxValueValidator(20)])
...
class UserSelection(models.Model):
    ...
    league = models.ForeignKey(League, on_delete=models.CASCADE, related_name='selections')
    round = models.ForeignKey(Round, on_delete=models.CASCADE, related_name='selections')
    player = models.ForeignKey(Player, on_delete=models.CASCADE, related_name='user_selections')
    selection_order = models.IntegerField()  # Order in which player was selected (1, 2, or 3)
    created_at = models.DateTimeField(auto_now_add=True)
...
class ProvisionalSelection(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='provisional_selections')
    league = models.ForeignKey(League, on_delete=models.CASCADE, related_name='provisional_selections')
    round = models.ForeignKey(Round, on_delete=models.CASCADE, related_name='provisional_selections')
    player = models.ForeignKey(Player, on_delete=models.CASCADE, related_name='provisional_selections')
...
class SelectionOrder(models.Model):
    ...
    league = models.ForeignKey(League, on_delete=models.CASCADE, related_name='selection_orders')
    round = models.ForeignKey(Round, on_delete=models.CASCADE, related_name='selection_orders')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='selection_orders')
